...
STRATEGY_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "ema_cross": {
        ...
        "optimization_ranges": {"fast_period": [8, 12, 16, 20], "slow_period": [20, 26, 35, 50]},
    },
    "macd": {
        "name": "MACD 信号",
        ...
        "optimization_ranges": {"fast_period": [8, 10, 12, 14], "slow_period": [21, 24, 26, 30], "signal_period": [7, 9, 11]},
    },
    "momentum": {
        "name": "动量策略",
        ...
        "optimization_ranges": {"lookback": [10, 15, 20, 25, 30], "threshold": [0.02, 0.03, 0.05, 0.07, 0.10]},
    },
    "breakout": {
        "name": "突破策略",
        ...
        "optimization_ranges": {"lookback": [10, 20, 30, 50], "exit_lookback": [5, 10, 15, 20]},
    },
    "rsi": {
        "name": "RSI 均值回归",
        ...
        "optimization_ranges": {"period": [7, 14, 21], "oversold": [20, 25, 30, 35], "overbought": [65, 70, 75, 80]},
    },
    "bollinger": {
        "name": "布林带",
        ...
        "optimization_ranges": {"period": [10, 15, 20, 25], "std_dev": [1.5, 2.0, 2.5, 3.0]},
    },
    "mean_reversion": {
        "name": "均值回归",
        ...
        "optimization_ranges": {"ma_period": [15, 20, 30, 50], "entry_threshold": [0.01, 0.02, 0.03, 0.05], "exit_threshold": [0.00, 0.01, 0.02]},
    },
    "volume_momentum": {
        "name": "放量动量",
        ...
        "category": "量价",
        "tags": ["成交量", "动量", "量价"],
        "parameters": {"momentum_period": 20, "volume_period": 20, "momentum_threshold": 0.05, "volume_multiplier": 1.5},
        "optimization_ranges": {"momentum_period": [10, 20, 30], "volume_period": [10, 20, 30], "momentum_threshold": [0.03, 0.05, 0.07], "volume_multiplier": [1.2, 1.5, 2.0]},
    },
    "online_learning": {
        "name": "在线学习",
        ...
        "optimization_ranges": {"lookback": [10, 20, 30, 50], "learning_rate": [0.001, 0.01, 0.1], "update_frequency": [1, 5, 10, 20]},
    },
    "regime_aware": {
        "name": "市场状态感知",
        ...
        "category": "高级",
        "tags": ["regime", "自适应", "切换"],
        "parameters": {"regime_window": 50, "threshold": 0.02, "trend_strategy": "momentum", "range_strategy": "mean_reversion"},
        "optimization_ranges": {"regime_window": [20, 50, 100], "threshold": [0.01, 0.02, 0.05]},
    },
    "ensemble": {
        "name": "集成策略",
        ...
        "category": "高级",
        "tags": ["集成", "投票", "多策略"],
        "parameters": {"fast_period": 10, "slow_period": 20, "rsi_period": 14, "weight_method": "equal"},
        "optimization_ranges": {"fast_period": [5, 10, 15], "slow_period": [20, 30, 50], "rsi_period": [7, 14, 21]},
    },
}
