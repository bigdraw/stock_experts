...
.reasoning-panel {
  ...
  background: var(--border-subtle); border-radius: 0 var(--radius-sm) var(--radius-sm) 0;
}
.reasoning-head {
  display: flex; justify-content: space-between; align-items: center; cursor: pointer;
  padding: 4px 10px; font-size: var(--fs-meta); color: var(--text-tertiary); font-weight: var(--fw-medium);
}
...
.reasoning-body {
  ...
  color: var(--text-tertiary); font-size: var(--fs-label); line-height: 1.55; white-space: pre-wrap;
